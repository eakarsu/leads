...
import { decideHandoff, rolesAllowedToMutate } from '@/lib/lead-operations/service';
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json(await decideHandoff(prisma, { ...body, clientId, handoffId: id, actorId: actor.id }));
