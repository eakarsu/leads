...
import { retrySyncOperation } from '@/lib/lead-operations/service';
...
export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    return NextResponse.json(await retrySyncOperation(prisma, { ...body, clientId, operationId: id, actorId: actor.id }));
